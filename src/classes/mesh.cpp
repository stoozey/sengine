...
namespace classes {
    Mesh::Mesh(std::vector<structs::Vertex> vertices, std::vector<GLuint> indices, std::vector<std::shared_ptr<assets::Texture>> textures)
    ...
    void Mesh::Draw(std::shared_ptr<assets::Shader> shader) {
...
//                number = std::to_string(specularNr++);
            ...
            std::shared_ptr<assets::Texture> texture = textures[i];
